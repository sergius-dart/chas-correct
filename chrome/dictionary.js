...
*/
var dicts;//объявляем переменную. Если будет nodejs - она будет локальная. Если же браузер - глобальная.
(function() {//сокрытие в локальной области видимости
    'use strict';
    ...
    */
    ...
    {
        //удаяем наши словари
        delete orphoFragmentsToCorrect;
        delete orphoPostfixToCorrect;
        delete orphoPrefixToCorrect;
        delete orphoWordsToCorrect;
        //удаляем нашу ссылку на словари.
        delete dicts.dicts;
    }
    
    //заполняем внешную переменную.
    dicts = {
        dicts:[
    ...
    try{
        module.exports = dicts;//экспортируем "внешний символ".
    }catch(e){
        //Значит, не node.js
        //а раз не nodejs, то у нас уже все экспортировано ( см dicts )
    }
})()
